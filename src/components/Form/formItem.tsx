...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('as-row', {
    'as-row-no-label': !label
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'as-form-item-required': isRequired
  })
  const itemClass = classNames('as-form-item-control', {
    'as-form-item-has-error': hasError
  })
  ...
  const returnChildNode = React.cloneElement(
    child,
    { ...((child.props as unknown) as Record<string, any>), ...controlProps }
  )
  return (
    <div className={rowClass}>
      { label &&
        <div className='as-form-item-label'>
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      }
      <div className='as-form-item'>
        <div className={itemClass}>
          {returnChildNode}
        </div>
        { hasError && 
          <div className='as-form-item-explain'>
